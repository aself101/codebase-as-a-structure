...
*Rooms ordered by the distinct diagnostic sets marking them (a feature under two profiles, or two features drawing one set, is one set), then by marks (one per feature per profile), then by path; the first 5 are listed. 2 rooms carry the most (6); all are listed; a row below that count is one of the rooms at its count, first by path, and its row says how many there are (rooms under two or more marks).*

| room | distinct sets | marks | rooms at this count | diagnostic features that mark it |
|---|---|---|---|---|
| src/utils/async-handler.ts | 6 | 7 | 2 | dark_room, flooded_basement, hub, leaf_utility, maintainability/foundation, onboarding/foundation, scaffolding |
| src/utils/singleton.ts | 6 | 7 | 2 | dark_room, flooded_basement, hub, leaf_utility, maintainability/foundation, onboarding/foundation, scaffolding |
| src/db/connection.ts | 5 | 6 | 4 | corridor, hub, lit_room, maintainability/foundation, onboarding/foundation, scaffolding |
| src/routes/v1/schemas.ts | 5 | 6 | 4 | corridor, hub, lit_room, maintainability/foundation, onboarding/foundation, scaffolding |
| src/schemas/enums.ts | 5 | 6 | 4 | corridor, hub, lit_room, maintainability/foundation, onboarding/foundation, scaffolding |
...
- facts_hash: `059080ef729e205cc28187f9edb61b832779b93768e4a4d6776c8ee7834e5343`
- generator: `code`
