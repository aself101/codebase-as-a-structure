...
*validation `0.3.0` · substrate fingerprint `115c4483645a…` · validation fingerprint `15bd4503d2f2…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
- toolchain: dep_extractor=dependency-cruiser@18.2.0, git=git@2.53.0, history=pydriller@2.11, python=python@3.13.12, substrate=repo-substrate@0.5.0
...
| `uluops-registry-api` | tuning | tuning | `ac03adea22` | 963 | 456 | 267 | `fcb8c09ccb` | 193 | 405 | 0.888 | 131 | 0.323 | 0.295 | – |
...
- `eslint-3398431574b9-trunc-115c4483645a.substrate.json`: seed `1dc7cfaaec63…`, bytes `0dfc998c4608…`
- `eslint-3f20a57c6293-tip-115c4483645a.substrate.json`: seed `a50b92780e08…`, bytes `60da52da5805…`
- `eslint-5c8c2417b9ff-trunc-115c4483645a.substrate.json`: seed `284a5c2ea9e7…`, bytes `d93d72a1ba71…`
- `mcp-secure-server-4c99da71468c-trunc-115c4483645a.substrate.json`: seed `8fee00040541…`, bytes `8af1c2bd2675…`
- `mcp-secure-server-5348b3ef614d-tip-115c4483645a.substrate.json`: seed `0f53b2d16c24…`, bytes `09e7b5d2bda2…`
- `mcp-secure-server-654057ef9f62-trunc-115c4483645a.substrate.json`: seed `8fee00040541…`, bytes `b13b620f76ef…`
- `typeorm-ac41823b9e27-tip-115c4483645a.substrate.json`: seed `33fbe1cfaa1a…`, bytes `6526e55be42e…`
- `typeorm-f5c6aa3bfe9c-trunc-115c4483645a.substrate.json`: seed `190672469654…`, bytes `8a9139961044…`
- `typeorm-fe7f328fd5b9-trunc-115c4483645a.substrate.json`: seed `df3baed073ea…`, bytes `4606c5634b22…`
- `uluops-registry-api-1abacd8df3cf-trunc-115c4483645a.substrate.json`: seed `f60d387051a1…`, bytes `a87ccce43fed…`
- `uluops-registry-api-ac03adea221a-tip-115c4483645a.substrate.json`: seed `a45a442fe431…`, bytes `3e4bbbb65ac2…`
- `uluops-registry-api-fcb8c09ccb29-trunc-115c4483645a.substrate.json`: seed `0b274cab4abb…`, bytes `87f35c232c66…`
...
| `bug_pressure_index` | **unvalidated** | `uluops-registry-api` | tuning | 0.720 | 0.699 (busyness) | 0.570 | 0.572 | 0.323 | 0.800 | 0.83 | no | roc_margin, pr_auc_mult |
...
| `change_pressure_index` | **unvalidated** | `uluops-registry-api` | tuning | 0.746 | 0.699 (busyness) | 0.564 | 0.572 | 0.323 | 0.800 | 0.63 | no | roc_margin, pr_auc_mult |
...
- **`bug_pressure_index`** — `unvalidated` (passed_on_0_of_2_test_repos_need_2).
  ...
  - `uluops-registry-api`: ROC-AUC 0.720 vs busyness 0.699 (Δ +0.021, need +0.05); PR-AUC 0.570 vs 0.572 (×1.00, need ×1.2); failed: roc_margin, pr_auc_mult.
...
- **`change_pressure_index`** — `unvalidated` (passed_on_1_of_2_test_repos_need_2).
  ...
  - `uluops-registry-api`: ROC-AUC 0.746 vs busyness 0.699 (Δ +0.047, need +0.05); PR-AUC 0.564 vs 0.572 (×0.98, need ×1.2); failed: roc_margin, pr_auc_mult.
...
| `age_days` | G3 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 114 | yes | `blame_age_median` | 267 | 0.792 | [0.734, 0.848] | 0.001 | yes |
...
| `author_count` | G1 | **asserted** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (226; max) | 1 | no | `git log` | – | – | – | – | yes |
...
| `blame_age_median` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 139 | yes | `git blame -w` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (454; max) | 310 | yes | `git blame -w` | – | – | – | – | yes |
| `centrality` | G4 | **asserted** | `typeorm` | – | 0.001 / 0.004 / 0.239 (529; p95) | 55 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `mcp-secure-server` | – | 0.003 / 0.023 / 0.040 (173; p95) | 52 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `uluops-registry-api` | unstable | 0.013 / 0.022 / 0.210 (226; p95) | 52 | no | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `eslint` | – | 0.000 / 0.001 / 0.027 (455; p95) | 38 | yes | `–` | – | – | – | – | derived |
...
| `churn_lines` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 155 | yes | `git log --numstat` | – | – | – | – | yes |
...
| `cochange_degree` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 31 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
...
| `commit_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 27 | yes | `git log` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 75 | yes | `git log` | – | – | – | – | yes |
| `complexity_proxy_index` | G4 | **asserted** | `typeorm` | – | 0.001 / 0.003 / 0.004 (529; p95) | 378 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.004 / 0.009 / 0.012 (173; p95) | 145 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.003 / 0.005 / 0.007 (226; p95) | 206 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `eslint` | – | 0.000 / 0.001 / 0.002 (455; p95) | 399 | yes | `–` | – | – | – | – | derived |
| `fan_in` | G2 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.018 (529; p95) | 49 | yes | `fan_in_alt` | 582 | 0.999 | [0.998, 1.000] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.020 (173; p95) | 11 | yes | `fan_in_alt` | 203 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.002 / 0.086 (226; p95) | 22 | yes | `fan_in_alt` | 261 | 0.995 | [0.991, 0.998] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.010 (455; p95) | 13 | yes | `fan_in_alt` | 472 | 0.981 | [0.944, 1.000] | 0.001 | yes |
| `fan_in_nonzero` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.019 (508; p95) | 48 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.002 / 0.027 (130; p95) | 10 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.004 / 0.149 (131; p95) | 21 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.011 (396; p95) | 12 | yes | `–` | – | – | – | – | derived |
| `fan_out` | G2 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (529; p95) | 32 | yes | `fan_out_alt` | 582 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (173; p95) | 7 | yes | `fan_out_alt` | 203 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; p95) | 14 | yes | `fan_out_alt` | 261 | 1.000 | [1.000, 1.000] | 0.001 | yes |
...
| `fix_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 19 | yes | `git log` | – | – | – | – | yes |
...
| `has_sibling_test` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; p95) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
...
| `is_package_entry` | G1 | **asserted** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (226; p95) | 1 | no | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
...
| `last_touched_days` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 118 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 125 | yes | `git log author_date` | – | – | – | – | yes |
| `load_index` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.001 / 0.075 (529; p95) | 449 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.007 / 0.015 / 0.041 (173; p95) | 158 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.004 / 0.009 / 0.103 (226; p95) | 199 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.011 (455; p95) | 381 | yes | `–` | – | – | – | – | derived |
...
| `neglect_index` | G3 | **untested** | `uluops-registry-api` | unstable | 0.015 / 0.057 / 0.221 (226; p95) | 184 | no | `blame_age_median` | 267 | 0.651 | [0.601, 0.698] | 0.001 | yes |
...
| `nesting_proxy` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 11 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
...
| `recent_commit_share` | G1 | **untested** | `uluops-registry-api` | unstable | 0.011 / 0.044 / 0.635 (226; p95) | 30 | no | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
...
| `reinforcement_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.003 / 0.312 (173; p95) | 4 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.002 / 0.650 (226; p95) | 12 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.003 (455; p95) | 7 | yes | `–` | – | – | – | – | derived |
...
| `revert_count` | G1 | **untested** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (226; max) | 1 | no | `git log` | – | – | – | – | yes |
...
| `size_loc` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (226; max) | 143 | yes | `non-blank line count` | – | – | – | – | yes |
...
| `test_fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.006 / 0.191 (173; p95) | 4 | yes | `test_fan_in_alt` | 203 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.002 / 0.004 / 0.416 (226; p95) | 12 | yes | `test_fan_in_alt` | 261 | 0.986 | [0.976, 0.995] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.004 (455; p95) | 7 | yes | `test_fan_in_alt` | 472 | 0.975 | [0.932, 1.000] | 0.001 | yes |
...
- `centrality` ~ `cochange_degree` on `mcp-secure-server`: τ 0.29 [0.18, 0.38]
- `centrality` ~ `cochange_degree` on `uluops-registry-api`: τ 0.38 [0.29, 0.46]
...
- `load_index` ~ `cochange_degree` on `mcp-secure-server`: τ 0.32 [0.22, 0.41]
- `load_index` ~ `test_fan_in` on `mcp-secure-server`: τ 0.53 [0.47, 0.60]
...
| signal | source | ranked & present | overlap@10 | τ-b on ranked | items not in substrate |
|---|---|---:|---:|---:|---|
| `bug_pressure_index` | list 2 | 9 | 0.10 | -0.33 | `package.json` |
