...
*Rendered from the facts sheet by code; no model wrote any of it. Every cell is a field, and every fixed text on the page has a test that asserts it against the sheet it is rendered from (`tests/test_brief.py`); the tests run on a fixture, not on this page. Profile maintainability 0.2.9 + onboarding 0.2.6, geometry age, skeleton `cca967e7f6e9…`, facts `625687f72edb…`. As of 2026-08-31, commit `f7414cc7bbec`. Calibration: in-repo, self-relative (system spec §5.3); one frame — stability is the `substrate timelapse` run under gate `179d8acb7b0c`, not this page. Brief 0.29.0.*
...
- facts_hash: `625687f72edb749b95bb2487af9579d719740b5509162ef98f394e2136578835`
- generator: `code`
