...
*validation `0.3.0` · substrate fingerprint `179d8acb7b0c…` · validation fingerprint `74a1e4f997d4…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
| `age_days` | G3 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 17 | yes | `blame_age_median` | 202 | 0.883 | [0.791, 0.953] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 112 | yes | `blame_age_median` | 267 | 0.793 | [0.735, 0.848] | 0.001 | yes |
...
| `author_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 2 | yes | `git log` | – | – | – | – | yes |
| `author_count` | G1 | **asserted** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (222; max) | 1 | no | `git log` | – | – | – | – | yes |
...
| `blame_age_median` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 18 | yes | `git blame -w` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 137 | yes | `git blame -w` | – | – | – | – | yes |
...
| `centrality` | G4 | **asserted** | `mcp-secure-server` | – | 0.003 / 0.025 / 0.036 (179; p95) | 50 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `uluops-registry-api` | unstable | 0.014 / 0.020 / 0.209 (222; p95) | 51 | no | `–` | – | – | – | – | derived |
...
| `churn_lines` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 128 | yes | `git log --numstat` | – | – | – | – | yes |
| `churn_lines` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 151 | yes | `git log --numstat` | – | – | – | – | yes |
...
| `cochange_degree` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 10 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
| `cochange_degree` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 30 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
...
| `commit_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 10 | yes | `git log` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 26 | yes | `git log` | – | – | – | – | yes |
...
| `complexity_proxy_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.002 / 0.005 / 0.009 (179; p95) | 153 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.003 / 0.006 / 0.007 (222; p95) | 203 | yes | `–` | – | – | – | – | derived |
...
| `fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.003 / 0.134 (179; p95) | 10 | yes | `fan_in_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.002 / 0.088 (222; p95) | 21 | yes | `fan_in_alt` | 261 | 0.995 | [0.991, 0.998] | 0.001 | yes |
...
| `fan_in_nonzero` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.004 / 0.176 (136; p95) | 9 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.004 / 0.151 (129; p95) | 20 | yes | `–` | – | – | – | – | derived |
...
| `fan_out` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; p95) | 8 | yes | `fan_out_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; p95) | 13 | yes | `fan_out_alt` | 261 | 1.000 | [1.000, 1.000] | 0.001 | yes |
...
| `fix_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 4 | yes | `git log` | – | – | – | – | yes |
| `fix_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 18 | yes | `git log` | – | – | – | – | yes |
...
| `has_sibling_test` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; p95) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
| `has_sibling_test` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; p95) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
...
| `is_package_entry` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; p95) | 2 | yes | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
| `is_package_entry` | G1 | **asserted** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (222; p95) | 1 | no | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
...
| `last_touched_days` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 32 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 116 | yes | `git log author_date` | – | – | – | – | yes |
...
| `load_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.002 / 0.006 / 0.097 (179; p95) | 161 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.003 / 0.008 / 0.103 (222; p95) | 197 | yes | `–` | – | – | – | – | derived |
...
| `neglect_index` | G3 | **untested** | `mcp-secure-server` | unstable | 0.008 / 0.119 / 0.239 (179; p95) | 49 | no | `blame_age_median` | 202 | 0.593 | [0.508, 0.685] | 0.001 | yes |
| `neglect_index` | G3 | **untested** | `uluops-registry-api` | unstable | 0.016 / 0.064 / 0.228 (222; p95) | 179 | no | `blame_age_median` | 267 | 0.653 | [0.603, 0.700] | 0.001 | yes |
| `neglect_index` | G3 | **untested** | `eslint` | – | 0.004 / 0.014 / 0.067 (455; p95) | 416 | yes | `blame_age_median` | 472 | 0.373 | [0.320, 0.427] | 0.001 | yes |
| `nesting_proxy` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (529; max) | 19 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 10 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 11 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 21 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `typeorm` | – | 0.003 / 0.009 / 0.356 (529; p95) | 130 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `mcp-secure-server` | degenerate | 0.000 / 0.000 / 0.000 (179; p95) | 5 | no | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `uluops-registry-api` | – | 0.009 / 0.032 / 0.633 (222; p95) | 26 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `eslint` | – | 0.003 / 0.010 / 0.116 (455; p95) | 180 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `reinforcement_index` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.001 / 0.610 (529; p95) | 28 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; p95) | 4 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.002 / 0.650 (222; p95) | 11 | yes | `–` | – | – | – | – | derived |
...
| `revert_count` | G1 | **untested** | `mcp-secure-server` | degenerate | 0.000 / 0.000 / 0.000 (179; max) | 1 | no | `git log` | – | – | – | – | yes |
| `revert_count` | G1 | **untested** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (222; max) | 1 | no | `git log` | – | – | – | – | yes |
...
| `size_loc` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; max) | 127 | yes | `non-blank line count` | – | – | – | – | yes |
| `size_loc` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (222; max) | 140 | yes | `non-blank line count` | – | – | – | – | yes |
...
| `test_fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (179; p95) | 4 | yes | `test_fan_in_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.002 / 0.005 / 0.417 (222; p95) | 11 | yes | `test_fan_in_alt` | 261 | 0.986 | [0.976, 0.995] | 0.001 | yes |
