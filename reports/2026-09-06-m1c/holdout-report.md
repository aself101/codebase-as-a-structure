...
*validation `0.3.0` · substrate fingerprint `179d8acb7b0c…` · validation fingerprint `4c2f5291869c…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
- `eslint-9d8153223dbf-trunc-179d8acb7b0c.substrate.json`: seed `62f015640c92…`, bytes `0628f98c8e43…`
- `mcp-secure-server-080f992e6dba-trunc-179d8acb7b0c.substrate.json`: seed `11e5fdeb2290…`, bytes `1f910f4e851e…`
...
- `typeorm-8cf22582d32f-trunc-179d8acb7b0c.substrate.json`: seed `024e7a62a7e3…`, bytes `2577e6c7a791…`
...
- `uluops-registry-api-2ff7b5b7067e-trunc-179d8acb7b0c.substrate.json`: seed `c576e0759dc9…`, bytes `6c8459147b0f…`
...
| `is_package_entry` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 2 | yes | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
| `is_package_entry` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 2 | yes | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
| `is_package_entry` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 2 | yes | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
| `is_package_entry` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (462) | 2 | yes | `package.json main/module/browser/types/bin/exports` | – | – | – | – | yes |
