# Phase 1 — time-lapse reading across the reference set (D-021; gate `179d8acb7b0c`)

*Generated 2026-09-06. `substrate timelapse`, twelve evenly spaced first-parent checkpoints per repository, maintainability + onboarding overlay; every frame governed by the gate at HEAD — substrate fingerprint `179d8acb7b0c`, validation config `74a1e4f997d4`, validated 2026-09-06T21:36:14+00:00 — read from the manifests beside this file (D-035: the header states what the rows state, or it states nothing). Earlier readings (`reports/2026-09-05-phase1/`, `-phase1b/`, `2026-09-06-phase1x/`, `2026-09-06b-phase1x/`) are kept as the record of the instruments that produced them. Per-run reports, manifests, and scrubber pages sit beside this file as `<repo>.<geometry>.*`. Spec: `time-lapse-spec.md`.*
...
| mcp-secure-server | age | 12 frames | 134 | 12/0 | 138 | 12 | 870 | 0.27 | 0.19 | 0.27 | 0.03 | **0.30** | 0.24 | untested: below_pinned_k × 11 |
| mcp-secure-server | layer | 12 frames | 134 | 12/0 | 138 | 12 | 704 | 0.31 | 0.23 | 0.12 | 0.04 | **0.16** | 0.30 | untested: below_pinned_k × 11 |
...
| typeorm | age | 12 frames | 3,804 | 12/0 | 6,064 | 374 | 5,712 | 0.68 | 0.04 | 0.07 | 0.02 | **0.09** | 0.19 | untested: beyond_pinned_k × 11 |
