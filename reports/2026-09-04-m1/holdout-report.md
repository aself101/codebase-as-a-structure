...
*validation `0.3.0` · substrate fingerprint `80b2a632f8b7…` · validation fingerprint `cb320f191852…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
- asserted: K 5, **stability eps 0.05 / delta 0.15**, min compared 30, max excluded 0.5, max modal share 0.97, τ floors G3 0.3 / G2 0.6, retire 0.85, **m_asserted 2**
...
- toolchain: dep_extractor=dependency-cruiser@18.2.0, git=git@2.53.0, history=pydriller@2.11, python=python@3.13.12, substrate=repo-substrate@0.2.2
...
- `eslint-3398431574b9-trunc-80b2a632f8b7.substrate.json`: seed `1dc7cfaaec63…`, bytes `329504cbaac8…`
- `eslint-3f20a57c6293-tip-80b2a632f8b7.substrate.json`: seed `a50b92780e08…`, bytes `b3dc4d2662e8…`
- `eslint-9d8153223dbf-trunc-80b2a632f8b7.substrate.json`: seed `62f015640c92…`, bytes `72dab2bc21ab…`
- `mcp-secure-server-080f992e6dba-trunc-80b2a632f8b7.substrate.json`: seed `11e5fdeb2290…`, bytes `dab4b518a2ef…`
- `mcp-secure-server-3f55fd476ded-trunc-80b2a632f8b7.substrate.json`: seed `5fad71a46159…`, bytes `f6b65cd5291e…`
- `mcp-secure-server-ecb30716b87e-tip-80b2a632f8b7.substrate.json`: seed `2c7db66a25f4…`, bytes `c8ca2c716bfa…`
- `typeorm-8cf22582d32f-trunc-80b2a632f8b7.substrate.json`: seed `024e7a62a7e3…`, bytes `be69372888d3…`
- `typeorm-ac41823b9e27-tip-80b2a632f8b7.substrate.json`: seed `33fbe1cfaa1a…`, bytes `48f7110ed9c6…`
- `typeorm-fe7f328fd5b9-trunc-80b2a632f8b7.substrate.json`: seed `df3baed073ea…`, bytes `396606e394f6…`
- `uluops-registry-api-2ff7b5b7067e-trunc-80b2a632f8b7.substrate.json`: seed `c576e0759dc9…`, bytes `370088191075…`
- `uluops-registry-api-417d4387a048-trunc-80b2a632f8b7.substrate.json`: seed `f564280e55a8…`, bytes `565bb5a13a3e…`
- `uluops-registry-api-f7414cc7bbec-tip-80b2a632f8b7.substrate.json`: seed `c576e0759dc9…`, bytes `635f9ee194c6…`
...
| `bug_pressure_index` | **unvalidated** | `mcp-secure-server` | test | 0.828 | 0.825 (recency) | 0.406 | 0.261 | 0.086 | 0.500 | 0.72 | no | roc_margin |
| `bug_pressure_index` | **unvalidated** | `uluops-registry-api` | tuning | 0.722 | 0.697 (busyness) | 0.586 | 0.585 | 0.328 | 1.000 | 0.82 | no | roc_margin, pr_auc_mult |
...
| `change_pressure_index` | **unvalidated** | `mcp-secure-server` | test | 0.856 | 0.825 (recency) | 0.438 | 0.261 | 0.086 | 0.700 | 0.54 | no | roc_margin |
...
- **`bug_pressure_index`** — `unvalidated` (passed_on_0_of_2_test_repos_need_2).
  ...
  - `mcp-secure-server`: ROC-AUC 0.828 vs recency 0.825 (Δ +0.004, need +0.05); PR-AUC 0.406 vs 0.261 (×1.55, need ×1.2); failed: roc_margin.
  - `uluops-registry-api`: ROC-AUC 0.722 vs busyness 0.697 (Δ +0.025, need +0.05); PR-AUC 0.586 vs 0.585 (×1.00, need ×1.2); failed: roc_margin, pr_auc_mult.
...
- **`change_pressure_index`** — `unvalidated` (passed_on_1_of_2_test_repos_need_2).
  ...
  - `mcp-secure-server`: ROC-AUC 0.856 vs recency 0.825 (Δ +0.031, need +0.05); PR-AUC 0.438 vs 0.261 (×1.68, need ×1.2); failed: roc_margin.
...
|---|---|---|---|---|---:|---:|---|---|---:|---:|---|---:|---|
| `age_days` | G3 | **asserted** | `typeorm` | – | 0.000 / 0.002 / 0.009 (576) | 208 | yes | `blame_age_median` | 583 | 0.483 | [0.427, 0.536] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.002 (188) | 8 | yes | `blame_age_median` | 202 | 0.766 | [0.669, 0.847] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `uluops-registry-api` | – | 0.004 / 0.072 / 0.107 (267) | 66 | yes | `blame_age_median` | 267 | 0.780 | [0.721, 0.835] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.008 (462) | 323 | yes | `blame_age_median` | 472 | 0.378 | [0.316, 0.437] | 0.001 | yes |
| `author_count` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.001 / 0.001 (576) | 42 | yes | `git log` | – | – | – | – | yes |
| `author_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 2 | yes | `git log` | – | – | – | – | yes |
| `author_count` | G1 | **asserted** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (267) | 2 | no | `git log` | – | – | – | – | yes |
| `author_count` | G1 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (462) | 48 | yes | `git log` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 228 | yes | `git blame -w` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.002 / 0.005 (188) | 19 | yes | `git blame -w` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 161 | yes | `git blame -w` | – | – | – | – | yes |
| `blame_age_median` | G1 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (461) | 315 | yes | `git blame -w` | – | – | – | – | yes |
| `centrality` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 58 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.022 / 0.032 (188) | 53 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 59 | yes | `–` | – | – | – | – | derived |
| `centrality` | G4 | **asserted** | `eslint` | – | 0.002 / 0.002 / 0.029 (462) | 39 | yes | `–` | – | – | – | – | derived |
| `churn_lines` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.002 / 0.002 (576) | 323 | yes | `git log --numstat` | – | – | – | – | yes |
| `churn_lines` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.007 / 0.010 (188) | 135 | yes | `git log --numstat` | – | – | – | – | yes |
| `churn_lines` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 186 | yes | `git log --numstat` | – | – | – | – | yes |
| `churn_lines` | G1 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (462) | 403 | yes | `git log --numstat` | – | – | – | – | yes |
| `cochange_degree` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 87 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
| `cochange_degree` | G1 | **asserted** | `mcp-secure-server` | – | 0.005 / 0.025 / 0.030 (188) | 11 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
| `cochange_degree` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 44 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
| `cochange_degree` | G1 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (462) | 46 | yes | `git log co-occurrence (§5)` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.002 / 0.002 (576) | 86 | yes | `git log` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.012 / 0.015 (188) | 10 | yes | `git log` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 37 | yes | `git log` | – | – | – | – | yes |
| `commit_count` | G1 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (462) | 76 | yes | `git log` | – | – | – | – | yes |
| `complexity_proxy_index` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.001 (576) | 410 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.001 / 0.004 / 0.007 (188) | 160 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 246 | yes | `–` | – | – | – | – | derived |
| `complexity_proxy_index` | G4 | **asserted** | `eslint` | – | 0.000 / 0.001 / 0.001 (462) | 406 | yes | `–` | – | – | – | – | derived |
| `fan_in` | G2 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 55 | yes | `fan_in_alt` | 582 | 0.999 | [0.998, 1.000] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.002 / 0.002 (188) | 10 | yes | `fan_in_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 26 | yes | `fan_in_alt` | 261 | 0.995 | [0.991, 0.998] | 0.001 | yes |
| `fan_in` | G2 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.011 (462) | 13 | yes | `fan_in_alt` | 472 | 0.981 | [0.944, 1.000] | 0.001 | yes |
| `fan_in_nonzero` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (553) | 54 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.003 / 0.003 (145) | 9 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (168) | 25 | yes | `–` | – | – | – | – | derived |
| `fan_in_nonzero` | G4 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.012 (402) | 12 | yes | `–` | – | – | – | – | derived |
| `fan_out` | G2 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 35 | yes | `fan_out_alt` | 582 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.002 / 0.002 (188) | 8 | yes | `fan_out_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 17 | yes | `fan_out_alt` | 261 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `fan_out` | G2 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.001 (462) | 10 | yes | `fan_out_alt` | 472 | 0.996 | [0.990, 1.000] | 0.001 | yes |
| `fix_count` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.001 / 0.001 (576) | 31 | yes | `git log` | – | – | – | – | yes |
| `fix_count` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 5 | yes | `git log` | – | – | – | – | yes |
| `fix_count` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 26 | yes | `git log` | – | – | – | – | yes |
| `fix_count` | G1 | **asserted** | `eslint` | – | 0.000 / 0.005 / 0.005 (462) | 27 | yes | `git log` | – | – | – | – | yes |
| `has_sibling_test` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
| `has_sibling_test` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
| `has_sibling_test` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
| `has_sibling_test` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (462) | 2 | yes | `path convention config (§6.2.2)` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `typeorm` | – | 0.002 / 0.009 / 0.038 (576) | 80 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.017 / 0.062 (188) | 15 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `uluops-registry-api` | – | 0.002 / 0.013 / 0.035 (267) | 70 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `eslint` | – | 0.001 / 0.017 / 0.028 (462) | 106 | yes | `git log author_date` | – | – | – | – | yes |
| `load_index` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 489 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.007 / 0.010 (188) | 169 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 239 | yes | `–` | – | – | – | – | derived |
| `load_index` | G4 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.011 (462) | 386 | yes | `–` | – | – | – | – | derived |
| `neglect_index` | G3 | **asserted** | `typeorm` | – | 0.001 / 0.004 / 0.100 (576) | 451 | yes | `blame_age_median` | 583 | 0.564 | [0.519, 0.602] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `mcp-secure-server` | unstable | 0.000 / 0.025 / 0.207 (188) | 32 | no | `blame_age_median` | 202 | 0.431 | [0.327, 0.544] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `uluops-registry-api` | – | 0.004 / 0.028 / 0.043 (267) | 192 | yes | `blame_age_median` | 267 | 0.653 | [0.601, 0.700] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `eslint` | – | 0.001 / 0.010 / 0.029 (462) | 416 | yes | `blame_age_median` | 472 | 0.373 | [0.321, 0.426] | 0.001 | yes |
| `nesting_proxy` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.001 / 0.001 (576) | 19 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `mcp-secure-server` | – | 0.002 / 0.008 / 0.008 (188) | 10 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 11 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `nesting_proxy` | G1 | **asserted** | `eslint` | – | 0.000 / 0.001 / 0.001 (462) | 21 | yes | `indent counter (§6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `typeorm` | unstable | 0.000 / 0.000 / 0.500 (576) | 152 | no | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `mcp-secure-server` | unstable | 0.000 / 0.000 / 1.000 (188) | 10 | no | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.040 (267) | 44 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.125 (462) | 184 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `reinforcement_index` | G4 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 32 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 4 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 13 | yes | `–` | – | – | – | – | derived |
| `reinforcement_index` | G4 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.003 (462) | 7 | yes | `–` | – | – | – | – | derived |
| `revert_count` | G1 | **untested** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 5 | yes | `git log` | – | – | – | – | yes |
| `revert_count` | G1 | **untested** | `mcp-secure-server` | degenerate | 0.000 / 0.000 / 0.000 (188) | 1 | no | `git log` | – | – | – | – | yes |
| `revert_count` | G1 | **untested** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (267) | 1 | no | `git log` | – | – | – | – | yes |
| `revert_count` | G1 | **untested** | `eslint` | degenerate | 0.000 / 0.000 / 0.000 (462) | 3 | no | `git log` | – | – | – | – | yes |
| `size_loc` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.002 / 0.002 (576) | 220 | yes | `non-blank line count` | – | – | – | – | yes |
| `size_loc` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.005 / 0.010 (188) | 133 | yes | `non-blank line count` | – | – | – | – | yes |
| `size_loc` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 174 | yes | `non-blank line count` | – | – | – | – | yes |
| `size_loc` | G1 | **asserted** | `eslint` | – | 0.001 / 0.001 / 0.003 (462) | 270 | yes | `non-blank line count` | – | – | – | – | yes |
| `test_fan_in` | G2 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 32 | yes | `test_fan_in_alt` | 582 | 0.997 | [0.990, 1.000] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 4 | yes | `test_fan_in_alt` | 202 | 1.000 | [1.000, 1.000] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 13 | yes | `test_fan_in_alt` | 261 | 0.986 | [0.976, 0.995] | 0.001 | yes |
| `test_fan_in` | G2 | **asserted** | `eslint` | – | 0.002 / 0.002 / 0.004 (462) | 7 | yes | `test_fan_in_alt` | 472 | 0.975 | [0.932, 1.000] | 0.001 | yes |
...
- `age_days` ↔ `blame_age_median` (G3): 0.48, 0.77, 0.78, 0.38
- `fan_in` ↔ `fan_in_alt` (G2): 1.00, 1.00, 0.99, 0.98
- `fan_out` ↔ `fan_out_alt` (G2): 1.00, 1.00, 1.00, 1.00
- `neglect_index` ↔ `blame_age_median` (G3): 0.56, 0.43, 0.65, 0.37
...
- `neglect_index` ~ `cochange_degree` on `typeorm`: τ 0.11 [0.06, 0.16]
- `neglect_index` ~ `cochange_degree` on `mcp-secure-server`: τ -0.32 [-0.41, -0.22]
- `neglect_index` ~ `cochange_degree` on `uluops-registry-api`: τ -0.11 [-0.20, -0.03]
