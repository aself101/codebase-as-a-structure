...
*validation `0.3.0` · substrate fingerprint `5f5554e36d4a…` · validation fingerprint `cb320f191852…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
- toolchain: dep_extractor=dependency-cruiser@18.2.0, git=git@2.53.0, history=pydriller@2.11, python=python@3.13.12, substrate=repo-substrate@0.3.0
...
- `eslint-3398431574b9-trunc-5f5554e36d4a.substrate.json`: seed `1dc7cfaaec63…`, bytes `f0e7338ae49f…`
- `eslint-3f20a57c6293-tip-5f5554e36d4a.substrate.json`: seed `a50b92780e08…`, bytes `055c3be1226a…`
- `eslint-9d8153223dbf-trunc-5f5554e36d4a.substrate.json`: seed `62f015640c92…`, bytes `324c7639b3c0…`
- `mcp-secure-server-080f992e6dba-trunc-5f5554e36d4a.substrate.json`: seed `11e5fdeb2290…`, bytes `7cec85cbc0c2…`
- `mcp-secure-server-3f55fd476ded-trunc-5f5554e36d4a.substrate.json`: seed `5fad71a46159…`, bytes `265c33e355de…`
- `mcp-secure-server-ecb30716b87e-tip-5f5554e36d4a.substrate.json`: seed `2c7db66a25f4…`, bytes `e3d0c868f529…`
- `typeorm-8cf22582d32f-trunc-5f5554e36d4a.substrate.json`: seed `024e7a62a7e3…`, bytes `3d75681789d5…`
- `typeorm-ac41823b9e27-tip-5f5554e36d4a.substrate.json`: seed `33fbe1cfaa1a…`, bytes `a43526d65ff2…`
- `typeorm-fe7f328fd5b9-trunc-5f5554e36d4a.substrate.json`: seed `df3baed073ea…`, bytes `8513dd32e9f6…`
- `uluops-registry-api-2ff7b5b7067e-trunc-5f5554e36d4a.substrate.json`: seed `c576e0759dc9…`, bytes `093ce5550360…`
- `uluops-registry-api-417d4387a048-trunc-5f5554e36d4a.substrate.json`: seed `f564280e55a8…`, bytes `43e6586df842…`
- `uluops-registry-api-f7414cc7bbec-tip-5f5554e36d4a.substrate.json`: seed `c576e0759dc9…`, bytes `861946caa401…`
...
|---|---|---|---|---|---:|---:|---|---|---:|---:|---|---:|---|
| `age_days` | G3 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (576) | 248 | yes | `blame_age_median` | 583 | 0.483 | [0.427, 0.535] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (188) | 18 | yes | `blame_age_median` | 202 | 0.883 | [0.791, 0.953] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 123 | yes | `blame_age_median` | 267 | 0.793 | [0.735, 0.848] | 0.001 | yes |
| `age_days` | G3 | **asserted** | `eslint` | – | 0.001 / 0.002 / 0.002 (462) | 389 | yes | `blame_age_median` | 472 | 0.378 | [0.316, 0.437] | 0.001 | yes |
...
| `last_touched_days` | G1 | **asserted** | `typeorm` | – | 0.002 / 0.009 / 0.012 (576) | 111 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.030 / 0.064 (188) | 37 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (267) | 127 | yes | `git log author_date` | – | – | – | – | yes |
| `last_touched_days` | G1 | **asserted** | `eslint` | – | 0.001 / 0.017 / 0.023 (462) | 132 | yes | `git log author_date` | – | – | – | – | yes |
...
| `neglect_index` | G3 | **asserted** | `typeorm` | – | 0.001 / 0.004 / 0.100 (576) | 453 | yes | `blame_age_median` | 583 | 0.564 | [0.519, 0.602] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `mcp-secure-server` | unstable | 0.000 / 0.026 / 0.208 (188) | 56 | no | `blame_age_median` | 202 | 0.593 | [0.508, 0.685] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.008 (267) | 224 | yes | `blame_age_median` | 267 | 0.653 | [0.603, 0.700] | 0.001 | yes |
| `neglect_index` | G3 | **asserted** | `eslint` | – | 0.001 / 0.009 / 0.029 (462) | 422 | yes | `blame_age_median` | 472 | 0.373 | [0.320, 0.427] | 0.001 | yes |
