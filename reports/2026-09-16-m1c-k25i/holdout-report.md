...
*validation `0.3.0` · substrate fingerprint `177c129be9b5…` · validation fingerprint `d42daadf3228…`. Verdicts are stated for fix-**activity** (the declared §3.4.1 proxy), never defect origin.*
...
- toolchain: dep_extractor=dependency-cruiser@18.2.0, git=git@2.53.0, history=pydriller@2.11, python=python@3.13.12, substrate=repo-substrate@0.10.0
...
| `uluops-registry-api` | tuning | tuning | `e947c5b675` | 965 | 456 | 267 | `844ad406f1` | 193 | 405 | 0.888 | 128 | 0.316 | 0.290 | – |
...
- `eslint-3398431574b9-trunc-177c129be9b5.substrate.json`: seed `1dc7cfaaec63…`, bytes `0567bcfc438f…`
- `eslint-3f20a57c6293-tip-177c129be9b5.substrate.json`: seed `a50b92780e08…`, bytes `b1d2e904c73d…`
- `eslint-5c8c2417b9ff-trunc-177c129be9b5.substrate.json`: seed `284a5c2ea9e7…`, bytes `8e4fcbbfe794…`
- `mcp-secure-server-4c99da71468c-trunc-177c129be9b5.substrate.json`: seed `8fee00040541…`, bytes `5ed68280fa1c…`
- `mcp-secure-server-5348b3ef614d-tip-177c129be9b5.substrate.json`: seed `0f53b2d16c24…`, bytes `1a657c8f8bb3…`
- `mcp-secure-server-654057ef9f62-trunc-177c129be9b5.substrate.json`: seed `8fee00040541…`, bytes `440046b38f5b…`
- `typeorm-ac41823b9e27-tip-177c129be9b5.substrate.json`: seed `33fbe1cfaa1a…`, bytes `1b9754fb4625…`
- `typeorm-f5c6aa3bfe9c-trunc-177c129be9b5.substrate.json`: seed `190672469654…`, bytes `090bec358830…`
- `typeorm-fe7f328fd5b9-trunc-177c129be9b5.substrate.json`: seed `df3baed073ea…`, bytes `679f84da93d0…`
- `uluops-registry-api-368c01673360-trunc-177c129be9b5.substrate.json`: seed `94ba0e0d9be4…`, bytes `b1cf58f590b4…`
- `uluops-registry-api-844ad406f17d-trunc-177c129be9b5.substrate.json`: seed `587c5931587e…`, bytes `ba7b5b8c7bba…`
- `uluops-registry-api-e947c5b67542-tip-177c129be9b5.substrate.json`: seed `dc1e90d46248…`, bytes `63b24ac3bcb1…`
...
| `bug_pressure_index` | **unvalidated** | `uluops-registry-api` | tuning | 0.725 | 0.708 (busyness) | 0.571 | 0.576 | 0.316 | 0.800 | 0.83 | no | roc_margin, pr_auc_mult |
...
| `change_pressure_index` | **unvalidated** | `uluops-registry-api` | tuning | 0.749 | 0.708 (busyness) | 0.564 | 0.576 | 0.316 | 0.800 | 0.63 | no | roc_margin, pr_auc_mult |
...
- **`bug_pressure_index`** — `unvalidated` (passed_on_0_of_2_test_repos_need_2).
  ...
  - `uluops-registry-api`: ROC-AUC 0.725 vs busyness 0.708 (Δ +0.017, need +0.05); PR-AUC 0.571 vs 0.576 (×0.99, need ×1.2); failed: roc_margin, pr_auc_mult.
...
- **`change_pressure_index`** — `unvalidated` (passed_on_1_of_2_test_repos_need_2).
  ...
  - `uluops-registry-api`: ROC-AUC 0.749 vs busyness 0.708 (Δ +0.041, need +0.05); PR-AUC 0.564 vs 0.576 (×0.98, need ×1.2); failed: roc_margin, pr_auc_mult.
...
- `is_migration`: untested — degenerate.
- `is_placeholder`: untested — degenerate.
- `last_touch_blame_ignored`: untested — degenerate.
...
| `is_config` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (529; max) | 2 | yes | `basename regex (config_file_regex) at the package root` | – | – | – | – | yes |
| `is_config` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (173; max) | 2 | yes | `basename regex (config_file_regex) at the package root` | – | – | – | – | yes |
| `is_config` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (227; max) | 2 | yes | `basename regex (config_file_regex) at the package root` | – | – | – | – | yes |
| `is_config` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 2 | yes | `basename regex (config_file_regex) at the package root` | – | – | – | – | yes |
| `is_migration` | G1 | **untested** | `typeorm` | – | 0.000 / 0.000 / 0.000 (529; max) | 2 | yes | `path regex (migration_dir_regex)` | – | – | – | – | yes |
| `is_migration` | G1 | **untested** | `mcp-secure-server` | degenerate | 0.000 / 0.000 / 0.000 (173; max) | 1 | no | `path regex (migration_dir_regex)` | – | – | – | – | yes |
| `is_migration` | G1 | **untested** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (227; max) | 2 | yes | `path regex (migration_dir_regex)` | – | – | – | – | yes |
| `is_migration` | G1 | **untested** | `eslint` | degenerate | 0.000 / 0.000 / 0.000 (455; max) | 1 | no | `path regex (migration_dir_regex)` | – | – | – | – | yes |
...
| `is_placeholder` | G1 | **untested** | `typeorm` | degenerate | 0.000 / 0.000 / 0.000 (529; max) | 1 | no | `content regex (placeholder_content_regex) after comment stripping` | – | – | – | – | yes |
| `is_placeholder` | G1 | **untested** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (173; max) | 2 | yes | `content regex (placeholder_content_regex) after comment stripping` | – | – | – | – | yes |
| `is_placeholder` | G1 | **untested** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (227; max) | 1 | no | `content regex (placeholder_content_regex) after comment stripping` | – | – | – | – | yes |
| `is_placeholder` | G1 | **untested** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 2 | yes | `content regex (placeholder_content_regex) after comment stripping` | – | – | – | – | yes |
| `last_touch_blame_ignored` | G1 | **untested** | `typeorm` | degenerate | 0.000 / 0.000 / 0.000 (529; max) | 1 | no | `.git-blame-ignore-revs at the analyzed rev` | – | – | – | – | yes |
| `last_touch_blame_ignored` | G1 | **untested** | `mcp-secure-server` | degenerate | 0.000 / 0.000 / 0.000 (173; max) | 1 | no | `.git-blame-ignore-revs at the analyzed rev` | – | – | – | – | yes |
| `last_touch_blame_ignored` | G1 | **untested** | `uluops-registry-api` | degenerate | 0.000 / 0.000 / 0.000 (227; max) | 1 | no | `.git-blame-ignore-revs at the analyzed rev` | – | – | – | – | yes |
| `last_touch_blame_ignored` | G1 | **untested** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 2 | yes | `.git-blame-ignore-revs at the analyzed rev` | – | – | – | – | yes |
| `last_touch_commit_files` | G1 | **asserted** | `typeorm` | – | 0.000 / 0.000 / 0.000 (529; max) | 47 | yes | `timeline: nodes touched by the file's newest commit` | – | – | – | – | yes |
| `last_touch_commit_files` | G1 | **asserted** | `mcp-secure-server` | – | 0.000 / 0.000 / 0.000 (173; max) | 19 | yes | `timeline: nodes touched by the file's newest commit` | – | – | – | – | yes |
| `last_touch_commit_files` | G1 | **asserted** | `uluops-registry-api` | – | 0.000 / 0.000 / 0.000 (227; max) | 25 | yes | `timeline: nodes touched by the file's newest commit` | – | – | – | – | yes |
| `last_touch_commit_files` | G1 | **asserted** | `eslint` | – | 0.000 / 0.000 / 0.000 (455; max) | 28 | yes | `timeline: nodes touched by the file's newest commit` | – | – | – | – | yes |
...
| `neglect_index` | G3 | **untested** | `uluops-registry-api` | unstable | 0.014 / 0.054 / 0.219 (227; p95) | 185 | no | `blame_age_median` | 267 | 0.651 | [0.600, 0.697] | 0.001 | yes |
...
| `recent_commit_share` | G1 | **asserted** | `mcp-secure-server` | degenerate | 0.043 / 0.451 / 0.488 (173; p95) | 1 | no | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
| `recent_commit_share` | G1 | **asserted** | `uluops-registry-api` | – | 0.009 / 0.041 / 0.632 (227; p95) | 30 | yes | `git log (timeline-relative window, §6.2.2)` | – | – | – | – | yes |
...
- `is_config`: tool-config basename (`x.config.ts`, `.xrc.js`, `x.conf.js`) in the directory that holds its package.json
- `is_migration`: a directory segment named migration(s) above the file
- `is_package_entry`: built entry → source mapping (./index.js → src/index.ts, dir → index)
- `is_placeholder`: nothing but an empty export (`export {}` / `module.exports = {}`)
- `last_touch_blame_ignored`: the newest commit's full sha appears in the file (comments stripped)
- `last_touch_commit_files`: a commit's breadth as the count of substrate nodes it touched
...
- `neglect_index` ~ `cochange_degree` on `uluops-registry-api`: τ -0.12 [-0.21, -0.04]
