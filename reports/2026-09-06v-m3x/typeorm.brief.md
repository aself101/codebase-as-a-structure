...
| foundation | maintainability | high-load node (import graph and size) | 59 | packages 2, src 57 | none holds a third | = foundation (same predicate, two profiles) | `load_index >= p90` |
...
| foundation | onboarding | high-load node (import graph and size) | 59 | packages 2, src 57 | none holds a third | = foundation (same predicate, two profiles) | `load_index >= p90` |
...
*4 rooms carry the most diagnostic marks (7, one per feature per profile); all are listed.*

| room | marks | diagnostic features that mark it |
|---|---|---|
| src/common/ObjectLiteral.ts | 7 | dark_room, flooded_basement, foundation, hub, leaf_utility, scaffolding |
| src/decorator/options/ValueTransformer.ts | 7 | dark_room, flooded_basement, foundation, hub, leaf_utility, scaffolding |
| src/error/TypeORMError.ts | 7 | dark_room, flooded_basement, foundation, hub, leaf_utility, scaffolding |
| src/index.ts | 7 | corridor, foundation, hub, lit_room, package_entry, scaffolding |
| src/data-source/DataSource.ts | 6 | corridor, foundation, hub, lit_room, scaffolding |
...
- facts_hash: `959b2339abb273babc705aee899fee8edc260c8355ab13b0e342545aa23b2c19`
- generator: `code`
