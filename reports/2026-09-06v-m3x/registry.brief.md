...
| foundation | maintainability | high-load node (import graph and size) | 27 | src 27 | none holds a third | = foundation (same predicate, two profiles) | `load_index >= p90` |
...
| foundation | onboarding | high-load node (import graph and size) | 27 | src 27 | none holds a third | = foundation (same predicate, two profiles) | `load_index >= p90` |
...
*2 rooms carry the most diagnostic marks (7, one per feature per profile); all are listed.*

| room | marks | diagnostic features that mark it |
|---|---|---|
| src/utils/async-handler.ts | 7 | dark_room, flooded_basement, foundation, hub, leaf_utility, scaffolding |
| src/utils/singleton.ts | 7 | dark_room, flooded_basement, foundation, hub, leaf_utility, scaffolding |
| src/db/connection.ts | 6 | corridor, foundation, hub, lit_room, scaffolding |
| src/routes/v1/schemas.ts | 6 | corridor, foundation, hub, lit_room, scaffolding |
| src/schemas/enums.ts | 6 | corridor, foundation, hub, lit_room, scaffolding |
...
- facts_hash: `0077b3bccce8d9789228b4acdd241ae8577360beddfa0181bd165130aee7ad64`
- generator: `code`
