...
8. **Asserted-bar defaults (§2.4).** `stability_perturbation_k` (25 since D-031; 5 until then), `stability_eps` (0.05), `stability_delta` (0.15), `tau_asserted` (0.30), `M_asserted` (2), and `signal_floor_mult` (1.5) are placeholders accepted under D-004 Q4; tune after the first real run.
