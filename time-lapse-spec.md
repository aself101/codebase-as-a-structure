...
2. **Geometry-specific strata ceiling** (D-018). The time-lapse reads layer-geometry strata movement at every frame; if it is consistently above age's by a stable factor, a separate ceiling is warranted.
